...
Android Frame Processor Plugins can be written in either **Java**, **Kotlin** or **C++ (JNI)**. You can build your VisionCamera Plugin either using the **vision-camera-plugin-builder** CLI, or by manually creating a native module and adding your code.

<Tabs
  defaultValue="automatic"
  values={[
    {label: 'Mostly Automatic Setup', value: 'automatic'},
    {label: 'Manual Setup', value: 'manual'}
  ]}>
<TabItem value="automatic">

The automatic setup runs a CLI that will automatically generate the plugin template for you.
...
2. If you don't want to ship your plugin to npm and only want to use it in your own app, register it in MainApplication.java:
...
The manual setup requires you to create
